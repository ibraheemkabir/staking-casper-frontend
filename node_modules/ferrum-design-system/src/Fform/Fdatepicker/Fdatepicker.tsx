...
export const FDatepicker = ({
  ...
  return (
    <>
      <div
        className={`f-input-group f-input-datepicker ${display ? `d-${display}` : ""
          } ${className} ${inputSize} `}
      >
        {label && (
          <label className={`f-input-label ${variant && `f-input-label-${variant}`}`}>
            {label}{" "}
        ...
        <div className="f-input-wrap">
          {prefix && (
            <div
              className={`f-input-group-prepend ${prefixAction ? "has-action" : ""
                }`}
            ...
            <Controller
              ...
              render={({ field: { onChange, name, selected, value } }: any) => {
                return (
                  <DatePicker
                    name={name}
                    className={`f-input-control ${variant && `f-input-control-${variant}`}`}
        ...
        {postfix && (
          <div
            className={`f-input-group-append ${postfixAction ? "has-action" : ""
              }`}

...
function Picking(ref) {
    ...
    return (
        React__default.createElement( 'div', {
            ...
            React__default.createElement( 'div', { className: "picking-area-overlay1" },
                React__default.createElement( 'div', { className: "picking-area-overlay2" },
                    React__default.createElement( 'div', { className: "picker-pointer", style: getPointerStyle })
                )
            )
        )
    );
...
function Preview(ref) {
    ...
    return (
        React__default.createElement( 'div', { className: "preview-area" },
            React__default.createElement( 'div', { className: "preview-box", style: style })
        )
    );
}
...
function Hue(ref) {
    ...
    return (
        React__default.createElement( 'div', {
            ...
            React__default.createElement( 'div', { className: "hue-area", ref: hueRef },
                React__default.createElement( 'div', {
...
function Alpha(ref) {
    ...
    return (
        React__default.createElement( 'div', {
            ...
            React__default.createElement( 'div', { className: "gradient", style: style }),
            React__default.createElement( 'div', { className: "alpha-area" },
                React__default.createElement( 'div', { className: "alpha-mask", ref: alphaMaskRef },
                    React__default.createElement( 'div', { className: "picker-pointer", style: pointerStyle })
                )
            )
        )
    );
...
function GradientPoint(ref) {
    ...
    return (
        React__default.createElement( 'div', {
            ...
            React__default.createElement( 'span', { className: ("child-point" + activeClassName) })
        )
    );
}
    ...
    var pointsContainer = function () { return (
        React__default.createElement( 'div', {
            ...
            points && points.map(function (point, index) { return (
                    React__default.createElement( GradientPoint, {
...
function Area(ref) {
    ...
    return (
        React__default.createElement( 'div', { className: "picker-area" },
            ...
            isGradient
                && (
                    React__default.createElement( GradientPoints, {
            ...
            React__default.createElement( 'div', { className: "preview" },
                ...
                React__default.createElement( 'div', { className: "color-hue-alpha" },
...
function Input(ref) {
    ...
    return (
        React__default.createElement( 'div', { className: ("input-field " + classes) },
...
function Preview$1(ref) {
    ...
    return (
        React__default.createElement( 'div', { className: "color-preview-area" },
...
function GradientControls(ref) {
    ...
    return (
        React__default.createElement( 'div', { className: "gradient-controls" },
            React__default.createElement( 'div', { className: "gradient-type" },
                React__default.createElement( 'div', {
            ...
            type === 'linear'
                && (
                    React__default.createElement( 'div', { className: "gradient-degrees-options" },
                        React__default.createElement( 'div', {
                            className: "gradient-degrees", onMouseDown: onMouseDown, onClick: onClickGradientDegree },
                            React__default.createElement( 'div', { className: "gradient-degree-center", style: degreesStyle },
                                React__default.createElement( 'div', { className: "gradient-degree-pointer" })
                            )
                        ),
                        React__default.createElement( 'div', { className: "gradient-degree-value" },
...
function Gradient(ref) {
    ...
    return (
        React__default.createElement( React__default.Fragment, null,
            React__default.createElement( GradientControls, {
...
function ColorPicker(ref) {
    ...
    return (
        React__default.createElement( 'div', { className: "ui-color-picker" },
            isGradient
                    ? (
                        React__default.createElement( Gradient, {
